    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b">
          ...
          <button onClick={onClose} className="lg:hidden p-1 rounded-md hover:bg-accent" aria-label="Close navigation menu">
            <X className="w-5 h-5" />
          </button>
        </div>
            ...
            <div key={item.name}>
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? "bg-gradient-to-r from-primary/15 to-violet-500/10 text-primary"
                    : "text-muted-foreground hover:bg-accent hover:text-foreground"
                )}
              >
                {isActive && (
                  <span className="absolute left-0 top-1/2 -translate-y-1/2 h-5 w-1 rounded-r-full bg-gradient-to-b from-primary to-violet-500" />
                )}
